...
namespace Grasp
{
    ...
    public class WindowResizer
    {
        ...
        /// </summary>
        public Rect CurrentScreenSize { get; private set; } = new Rect();
        #endregion
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void Window_LocationChanged(object sender, EventArgs e) => Window_SizeChanged(null, null);
        ...
        private void Window_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            ...
            var edgedTop = windowTopLeft.Y <= (CurrentScreenSize.Top + mEdgeTolerance) && windowTopLeft.Y >= (CurrentScreenSize.Top - mEdgeTolerance);
            var edgedLeft = windowTopLeft.X <= (CurrentScreenSize.Left + mEdgeTolerance) && windowTopLeft.X >= (CurrentScreenSize.Left - mEdgeTolerance);
            var edgedBottom = windowBottomRight.Y >= (CurrentScreenSize.Bottom - mEdgeTolerance) && windowBottomRight.Y <= (CurrentScreenSize.Bottom + mEdgeTolerance);
            var edgedRight = windowBottomRight.X >= (CurrentScreenSize.Right - mEdgeTolerance) && windowBottomRight.X <= (CurrentScreenSize.Right + mEdgeTolerance);
